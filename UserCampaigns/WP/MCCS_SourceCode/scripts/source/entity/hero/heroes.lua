...
Hero = 
{
    ...
    Params = 
    {
        ...
        Name =
        --- Возвращает путь к файлу имени героя 
    ...
    Stats = 
    {
        ...
        function(hero, stat, amount)
            ...
            if IsHeroAlive(hero) then
                MessageQueue.AddMessage(GetObjectOwner(hero), {'/Text/Default/change_stat.txt'; name = AdvMap.StatNames[stat], color = color, sign = sign, amount = amount}, hero, 5.0)
            end
        end
    },
