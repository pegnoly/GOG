...
COMBAT_LIGHTS =
{
  MORNING = '/Lights/_(AmbientLight)/M1/WP_M1_Ground_morning.(AmbientLight).xdb#xpointer(/AmbientLight)',
  DAY     = '/Lights/_(AmbientLight)/M1/WP_M1_Ground_dark_day.(AmbientLight).xdb#xpointer(/AmbientLight)',
...
function StartMap()
    ...
    --UGCombatLightInit()
    SetAmbientLight(GROUND, 'WP_M1_Ground_morning')
...
--StartDialogScene(DIALOG_SCENES.WITCHES_RITUAL)
