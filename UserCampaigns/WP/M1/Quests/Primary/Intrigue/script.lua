...
intrigue =
{
    ...
    function()
        ...
        -- Trigger(REGION_ENTER_AND_STOP_TRIGGER, 'show_garg_reg', 'FirstGargMeeting') -- в квест с гаргульями
        ...
        -- Trigger(REGION_ENTER_AND_STOP_TRIGGER, 'elem_trap_05', 'BreakSeal') -- в квест из таверны
